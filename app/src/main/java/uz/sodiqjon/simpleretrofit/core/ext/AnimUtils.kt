...
fun scaleUpAnimation(context: Context) = AnimationUtils.loadAnimation(context, R.anim.scale_up)

fun rotateAnimation(context: Context) = AnimationUtils.loadAnimation(context, R.anim.rotate)
...
fun transitionListener(
    transitionStart: () -> Unit,
    transitionEnd: () -> Unit
